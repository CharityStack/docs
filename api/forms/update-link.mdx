...
The request body is identical to [Create Link](/api/forms/create-link) — `name`, `destinationType`, `overlayPath`, and the full `prefill` object are all supported. The same validation rules apply.
