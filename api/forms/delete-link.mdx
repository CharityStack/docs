...
For a soft-delete that keeps the row visible in [List Links](/api/forms/list-links) under `?active=false` and can be undone, use [Deactivate](/api/forms/toggle-link) instead.
