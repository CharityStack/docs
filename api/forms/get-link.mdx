...
sidebarTitle: "Get Prefilled-Checkout Link"
...
<ResponseField name="active" type="boolean">
  Whether the link is active. Inactive links are visible via [List Links](/api/forms/list-links) with `?active=false` and can be re-enabled via [Activate](/api/forms/toggle-link).
</ResponseField>
